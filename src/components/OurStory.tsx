...
export default function OurStory() {
  return (
    <section className="bg-gray-50 w-full px-3 pb-16 md:pb-24 flex flex-col items-center">
      <div className="w-full max-w-[1920px] rounded-4xl overflow-hidden bg-white border border-black/5 shadow-sm p-8 md:p-16 lg:p-24 flex flex-col lg:flex-row gap-16 lg:gap-24 relative">
        ...
        <div className="flex-1 flex flex-col gap-6 md:gap-10">
          ...
          <div className="w-16 h-1 md:w-24 md:h-2 bg-[#7A1A1A] rounded-full"></div>
          ...
          <p className="text-gray-600 text-[15px] md:text-[17px] font-medium leading-[1.7] max-w-2xl">
            ...
            <br/><br/>
            Food customarily forms the crowning part of most festivals and celebrations. Whatever the occasion is Indians eat with great gusto and are always looking for reasons to feast and make merry. At traditional and festive meals, the thali (plate) or banana leaf is decorated with rangoli (a design drawn with white and colored powders around the edges). Thus keeping the same tradition alive, we at Kutchhi Caterers have been serving our guests for the past 25 years. So whatever the Occasion may be, do not forget to contact us for the satisfaction and feel of pure Indian Cuisine..
          </p>
          ...
          <div className="flex flex-wrap gap-4 mt-6">
            ...
            <span className="px-5 py-2.5 rounded-full bg-gray-100 border border-gray-200 text-[#2a873f] font-bold text-sm tracking-wide uppercase">100% Vegetrian</span>
            ...
            <span className="px-5 py-2.5 rounded-full bg-[#7A1A1A]/5 border border-[#7A1A1A]/10 text-[#7A1A1A] font-bold text-sm tracking-wide">Delicious Deals for Delicious Meals</span>
          </div>
        </div>
        ...
        <div className="flex-1 grid grid-cols-2 gap-4 md:gap-6">
          ...
          <div className="bg-black text-white rounded-[2rem] p-6 md:p-10 flex flex-col justify-center items-center text-center shadow-lg hover:bg-gray-900 transition-colors cursor-pointer">
            <span className="text-[3rem] md:text-[4.5rem] font-black tracking-tighter leading-none mb-2 text-[#7A1A1A]">25</span>
            <span className="text-white/80 font-semibold text-sm md:text-base tracking-tight uppercase">Years Of Experience</span>
          </div>
